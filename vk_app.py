...
while True:
    ...
    if scope == 5:
        ...
        last_date.append(groups_stats[0][1])
        ...
        if groups_stats[-1][1] == last_date[0]:
            print("update")
    ...
    for post in groups_posts:
        ...
        if str(post_dict["from_id"])[0] != '-':
            post_dict["from_id"] = '-' + str(post_dict["from_id"])
        post_dict['post link'] = "https://vk.com/wall{}_{}".format(post_dict['from_id'], post_dict['post id'])
